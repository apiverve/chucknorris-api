...
namespace APIVerve\Chucknorris;
...
/**
 * Client for the Chuck Norris Jokes API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/chucknorris?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/chucknorris';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\ChucknorrisClient] {$message}\n";
        }
    }
}
