# Chuck Norris Jokes API - Examples

This folder contains example code for using the Chuck Norris Jokes API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/chucknorris',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/chucknorris");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/chucknorris](https://docs.apiverve.com/ref/chucknorris)
