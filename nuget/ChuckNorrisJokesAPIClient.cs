...
namespace APIVerve.API.ChuckNorrisJokes
{
    /// <summary>
    ...
    /// <summary>
    /// Client for the ChuckNorrisJokes API
    /// </summary>
...
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/chucknorris";
        ...
        public ChuckNorrisJokesAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ChuckNorrisJokesAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ChuckNorrisJokesAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, ChuckNorrisJokesQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(ChuckNorrisJokesQueryOptions options)
        {
        ...
        public ResponseObj Execute(ChuckNorrisJokesQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(ChuckNorrisJokesQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(ChuckNorrisJokesQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(ChuckNorrisJokesQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(ChuckNorrisJokesQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(ChuckNorrisJokesQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(ChuckNorrisJokesQueryOptions options)
        {
