// Package chucknorris provides a Go client for the Chuck Norris Jokes API.
//
// For more information, visit: https://apiverve.com/marketplace/chucknorris?utm_source=go&utm_medium=readme
package chucknorris
...
const (
	baseURL        = "https://api.apiverve.com/v1/chucknorris"
	defaultTimeout = 30 * time.Second
)

// Client is the Chuck Norris Jokes API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Chuck Norris Jokes API client.
...
// Execute makes a request to the Chuck Norris Jokes API.
