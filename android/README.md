# Chuck Norris Jokes Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:chucknorris-api:1.1.14'
}
```
...
```java
import com.apiverve.chucknorris.ChuckNorrisJokesAPIClient;
import com.apiverve.chucknorris.APIResponse;
import com.apiverve.chucknorris.APIException;

// Initialize the client
ChuckNorrisJokesAPIClient client = new ChuckNorrisJokesAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/chucknorris](https://docs.apiverve.com/ref/chucknorris)
...
- **Documentation:** [https://docs.apiverve.com/ref/chucknorris](https://docs.apiverve.com/ref/chucknorris)
- **Issues:** [GitHub Issues](https://github.com/apiverve/chucknorris-api/issues)
